 ...
 * </ul>
 */
public class ChartScaleGestureDetector {
     ...
     * <ul>
     * <li>One {@link OnScaleGestureListener#onScaleBegin(ChartScaleGestureDetector)}
     * <li>Zero or more {@link OnScaleGestureListener#onScale(ChartScaleGestureDetector)}
     * <li>One {@link OnScaleGestureListener#onScaleEnd(ChartScaleGestureDetector)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         * pointers going up.
         * <p/>
         * Once a scale has ended, {@link ChartScaleGestureDetector#getFocusX()}
         * and {@link ChartScaleGestureDetector#getFocusY()} will return focal point
     ...
     * {@link OnScaleGestureListener#onScale(ChartScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(ChartScaleGestureDetector)} returns
     * {@code true}.
     */
     ...
     */
    public ChartScaleGestureDetector(Context context, OnScaleGestureListener listener) {
    ...
    public ChartScaleGestureDetector(Context context, OnScaleGestureListener listener,
        ...
        mContext = context;
        mListener = listener;
        mSpanSlop = 1; //ViewConfiguration.get(context).getScaledTouchSlop() * 2;

        final Resources res = context.getResources();
        mTouchMinMajor = 1;//res.getDimensionPixelSize(
//                com.android.internal.R.dimen.config_minScalingTouchMajor);
        mMinSpan = 1;//res.getDimensionPixelSize(com.android.internal.R.dimen.config_minScalingSpan);
        mHandler = handler;
